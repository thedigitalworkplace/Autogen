...
class TopicId(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["source", b"source", "type", b"type"]
    ) -> None: ...
...
class AgentId(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["key", b"key", "type", b"type"]
    ) -> None: ...
...
class Event(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_source", b"_source", "payload", b"payload", "source", b"source"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class RegisterAgentTypeRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["request_id", b"request_id", "type", b"type"]
    ) -> None: ...
...
class TypeSubscription(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "agent_type", b"agent_type", "topic_type", b"topic_type"
        ],
    ) -> None: ...
...
class TypePrefixSubscription(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "agent_type", b"agent_type", "topic_type_prefix", b"topic_type_prefix"
        ],
    ) -> None: ...
...
class AddSubscriptionRequest(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "request_id", b"request_id", "subscription", b"subscription"
        ],
    ) -> None: ...
...
class GetStateResponse(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_error", b"_error", "agent_state", b"agent_state", "error", b"error"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class SaveStateResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "_error", b"_error", "error", b"error", "success", b"success"
        ],
    ) -> None: ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_error", b"_error"]
...
class Message(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing.Literal["message", b"message"]) -> (
        typing.Literal[
            "request",
            "response",
            "cloudEvent",
